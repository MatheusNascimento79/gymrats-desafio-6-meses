...
- Sempre pergunte antes de fazer qualquer publicação em produção
- Busque documentação necessárias para que execute todo o processo de subir em produção com segurança e no padrão CerneOps, não crie novo processo
- Verifique o processo de Versionamento e registro de históricos
- Publicar em produção sempre replicando para o Template
- Se não tiver alguma informação, pergunte, não crie ou invente

### Comandos
- Após todo comando apresente seu entendimento e aguarde confirmação para iniciar qualquer execução
- Nunca execute algo sem confirmação prévia do que será realmente realizado
- Antes de qualquer execução apresente o que será feito e quais as entregas e peça aprovação
- Ao final da execução sempre apresente um check list do planejamento inicial
- Sempre registre em arquivos o Roadmap + Checklists

### Princípio chave
Arquivos locais servem apenas para processamento. Deliverables vivem na nuvem. Tudo em ⁠ .tmp/ ⁠ pode ser apagad